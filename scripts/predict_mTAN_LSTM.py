...
from load_model import load_mTANLSTM
...
for seed in range(nseeds):
    ...
    lstm = load_mTANLSTM(filename, input_dim, hidden_dim_lstm, n_lstm_layers, hidden_dim_mtan, embed_dim_mtan, num_heads, Lseq, output_dim, non_linear_transform, RS_inds)
